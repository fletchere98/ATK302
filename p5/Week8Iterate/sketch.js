...
dwarves[6] = "bashful" ;
  ...
  for (var i = 0; i < names.length; i++) { // you can just copy this or memorize it
    // where you start, until the length, and go through each one
    // var i only exists in this for function so you can yous
    console.log(names[i]);
  }
...
for (var i = 0; i < 100; i++) {
  ...
  randomNumbers[i] = random(255) ; // put a random number in the array
