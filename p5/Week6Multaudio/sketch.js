...
function preload() {
  song1 = loadSound('assets/NateWantsToBattleBones.mp3');
  song2 = loadSound('assets/NateWantsToBattlePhantom.mp3');
  song3 = loadSound('assets/NateWantsToBattleSmokeAndGuns.mp3');

  // set each song to loop and then immediately pause it so it doesn't play

  song1.loop();   //keep playing when it ends
  song1.stop();   //if they all are playing make sure you have this
  song2.loop();
  song2.stop();
  song3.loop();
  song3.stop();
